...
from tbl_recom_list t1 where t1.recomtime >'2013-03-08' and t1.recomtime<'2013-03-09'
 union all
 select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-09' and t1.recomtime<'2013-03-10'
 union all
 select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-10' and t1.recomtime<'2013-03-11'
 union all
  select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-11' and t1.recomtime<'2013-03-12'
 union all
  select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-12' and t1.recomtime<'2013-03-13'
 union all
  select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-13' and t1.recomtime<'2013-03-14'
 union all
  select min(t1.recomtime),sum(1)
from tbl_recom_list t1 where t1.recomtime >'2013-03-14' and t1.recomtime<='2013-03-14 23:59:59.999'
...
//呼叫次数日线   呼叫分钟数  主叫分钟数
select min(t1.logtime),sum(1),count(caller_start)
